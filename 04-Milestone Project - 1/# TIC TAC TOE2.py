    ...
    while not loopzaum:
        ...
        try:
            ...
            if (board_list[6] == "X" and board_list[7] == "X" and board_list[8] == "X") or \
               ...
               (board_list[0] == "X" and board_list[1] == "X" and board_list[2] == "X") or \
               (board_list[7] == "X" and board_list[4] == "X" and board_list[1] == "X") or \
               (board_list[8] == "X" and board_list[5] == "X" and board_list[2] == "X") or \
               (board_list[8] == "X" and board_list[4] == "X" and board_list[0] == "X"):
                loopzaum = True
                return "X VICTORY!!!"
            position = input("What position do you want to mark? ")
            if position.lower() == "stop":
            ...
            display_board(board_list)
            if (board_list[6] == "O" and board_list[7] == "O" and board_list[8] == "O") or \
               (board_list[6] == "O" and board_list[3] == "O" and board_list[0] == "O") or \
               (board_list[6] == "O" and board_list[4] == "O" and board_list[2] == "O") or \
               (board_list[3] == "O" and board_list[4] == "O" and board_list[5] == "O") or \
               (board_list[0] == "O" and board_list[1] == "O" and board_list[2] == "O") or \
               (board_list[7] == "O" and board_list[4] == "O" and board_list[1] == "O") or \
               (board_list[8] == "O" and board_list[5] == "O" and board_list[2] == "O") or \
               (board_list[8] == "O" and board_list[4] == "O" and board_list[0] == "O"):
                loopzaum = True
                return "OO VICTORY!!!"
